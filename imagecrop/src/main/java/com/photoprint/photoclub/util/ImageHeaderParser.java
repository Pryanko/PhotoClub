package com.photoprint.photoclub.util;
...
/**
 * Класс для разбора ориентации exif из заголовка изображения.
 *
...
public class ImageHeaderParser {
    ...
    /**
     * Константа, указывающая на то, что мы не смогли проанализировать ориентацию с изображения либо потому, что
     * сегмент exif, содержащий данные ориентации, не существовал, или из-за ошибки ввода-вывода при попытке
     * чтения exif.
     */
    ...
    /**
     * Проанализируйте ориентацию из заголовка изображения. Если он не обрабатывает этот тип изображения (или это
     * не изображение) возвращает значение по умолчанию, а не исключение.
     *
     * @return UNKNOWN_ORIENTATION если не прочитается ориентация
     */
